...
related: [../../01%20-%20GDD/dashboard-template.md, ../../03%20-%20TDD/guides/algorithmic/character-creation.md]
---

**Navegação:** [Home](../../../README.md) > [Documentação](../../index.md) > [Técnico](../index.md) > Regras D&D 5e (TDD)
...
>
> **📖 Para algoritmos completos com Design Patterns, veja:** [Guia Algorítmico Completo](../guides/algorithmic/character-creation.md)
>
</details>
---
...
> - **[Arquitetura Técnica](../architecture.md)** - Como as regras são implementadas
>
...
>
> - **[Data Architecture](../data-architecture/index.md)** - Estrutura de dados do projeto
>
> - **[Guia Algorítmico Completo](../guides/algorithmic/character-creation.md)** - Algoritmos detalhados com Design Patterns
>
</details>
---
