...
>
    ...
    >
    > <details>
    > <summary style="background-color: #d8d8d8; padding: 3px 6px; border-radius: 3px;">1. Ability Scores incompletos</summary>
    >
    > > **Erro:**
    > > ```
    ...
    >
    > <details>
    > <summary style="background-color: #d8d8d8; padding: 3px 6px; border-radius: 3px;">2. Raça não selecionada</summary>
    >
    > > **Erro:**
    > > ```
    ...
    >
    > <details>
    > <summary style="background-color: #d8d8d8; padding: 3px 6px; border-radius: 3px;">3. Background não selecionado</summary>
    >
    > > **Erro:**
    > > ```
    ...
    >
    > <details>
    > <summary style="background-color: #d8d8d8; padding: 3px 6px; border-radius: 3px;">4. Nível total inválido</summary>
    >
    > > **Erro:**
    > > ```
    ...
    >
    > <details>
    > <summary style="background-color: #d8d8d8; padding: 3px 6px; border-radius: 3px;">5. Ability Score fora de range</summary>
    >
    > > **Erro:**
    > > ```
    ...
    >
    > <details>
    > <summary style="background-color: #d8d8d8; padding: 3px 6px; border-radius: 3px;">1. Menos de 2 atributos escolhidos</summary>
    >
    > > **Solução:**
    ...
    >
    > <details>
    > <summary style="background-color: #d8d8d8; padding: 3px 6px; border-radius: 3px;">2. Feat não disponível</summary>
    >
    > > **Solução:**
    ...
    >
    > <details>
    > <summary style="background-color: #d8d8d8; padding: 3px 6px; border-radius: 3px;">3. Skill inválida</summary>
    >
    > > **Solução:**
