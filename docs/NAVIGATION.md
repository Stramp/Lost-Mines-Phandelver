...
category: root
tags: [navigation, map, index, overview]
...
> Este documento fornece um **mapa completo** de toda a documentação do projeto, organizado por diferentes perspectivas para facilitar a navegação e localização de informações.
...
<details>
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>🏠 Documentos na Raiz</b></summary>

> **Documentos principais do projeto:**
>

> - [README.md](../README.md) - Visão geral do projeto, estrutura, como começar
> - [ARCHITECTURE.md](../ARCHITECTURE.md) - Resumo executivo da arquitetura
...
<details>
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>🎨 Design</b></summary>

> **Índice:** [design/index.md](design/index.md)
>
...
<details>
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>🔧 Técnico</b></summary>

> **Índice:** [technical/index.md](technical/index.md)
>
> **Documentos Principais:**
>
> - [Arquitetura Técnica](technical/architecture.md) - Arquitetura completa do projeto
> - [API Reference](technical/api.md) - Referência completa da API
> - [Arquitetura de Dados](technical/data-architecture/) - Organização de dados e estruturas
>
> **Subcategorias:**
>
> **Arquitetura de Dados** (`technical/data-architecture/`):
>
...
>
> - [Índice](technical/guides/index.md)
> - [Getting Started](technical/guides/getting-started.md)
> - [Setup Completo](technical/guides/setup.md)
> - [Data Tables Setup](technical/guides/data-tables-setup.md)
> - [Data Tables](technical/guides/data-tables.md)
> - [Workflows](technical/guides/workflows.md)
> - [Testing](technical/guides/testing.md)
> - [TDD Complete Guide](technical/guides/tdd-complete-guide.md)
> - [Troubleshooting](technical/guides/troubleshooting.md)
> - [Algorítmico](technical/guides/algorithmic/character-creation.md)
>

</details>

<details>
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>📋 Planejamento</b></summary>

> **Índice:** [planning/index.md](planning/index.md)
>
> **Documentos Principais:**
>
...
> <details>
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>🚀 Quero começar do zero</b></summary>
...
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>🏗️ Quero entender a arquitetura</b></summary>

>     1. [ARCHITECTURE.md](../ARCHITECTURE.md) - Resumo executivo
>     2. [docs/technical/architecture.md](technical/architecture.md) - Arquitetura completa
>     3. [docs/technical/data-architecture/index.md](technical/data-architecture/index.md) - Arquitetura de dados
>     4. [docs/technical/api.md](technical/api.md) - Referência de API
>
...
<details>
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>💡 Conceitos Fundamentais</b></summary>
...
</details>>     - [Arquitetura Técnica](technical/architecture.md#data-driven)
>     - [Arquitetura de Dados](technical/data-architecture/database-architecture.md)
>     - [Glossário](GLOSSARY.md#data-driven-design)
>
...
>     - [Glossário](GLOSSARY.md#component-based-architecture)
>
...
>     - [Glossário](GLOSSARY.md#gameplay-ability-system)
>
...
<details>
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>📚 Documentos de Referência</b></summary>
...
> - [Getting Started](technical/guides/getting-started.md) - Primeiro personagem
> - [Setup](technical/guides/setup.md) - Configurar ambiente
> - [Data Tables Setup](technical/guides/data-tables-setup.md) - Criar Data Tables
> - [Workflows](technical/guides/workflows.md) - Fluxos principais
> - [Troubleshooting](technical/guides/troubleshooting.md) - Problemas comuns
>

</details>

<details>
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>⚠️ Relatórios e Análises</b></summary>

> - [High Performance Architectures](technical/data-architecture/high-performance-architectures-report.md) - Pesquisa
> - [Ideal Data Structure](technical/data-architecture/ideal-data-structure-report.md) - Estrutura ideal
>
...
> - [Roadmap](planning/roadmap.md) - Planejamento completo
...
<details>
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>🔍 Por Palavra-Chave</b></summary>
...
>
> **"API"** → [API Reference](technical/api.md)
>
</details>
---
...
<details>
<summary style="background-color: #e8e8e8; padding: 4px 8px; border-radius: 4px;"><b>💡 Como Usar Este Mapa</b></summary>

> 1. **Use o [Glossário](GLOSSARY.md)** para entender conceitos rapidamente
> 2. **Siga os breadcrumbs** no topo de cada documento para voltar
> 3. **Consulte o [Índice Principal](index.md)** para visão geral
> 4. **Use este mapa** quando não souber onde procurar
> 5. **Documentos grandes** têm TOC (Table of Contents) no início
>
