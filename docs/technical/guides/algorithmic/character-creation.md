...
>
> **⚠️ Importante:** Este documento segue a **ordem oficial do D&D Beyond** (Race → Class → Ability Scores → Describe → Equipment), que é usada no **Widget de criação de personagem** para o jogador final. Para a ordem técnica de processamento interno no Data Asset, veja [Character Creation Steps](../../../../design/dnd-rules/character-creation.md).
>
> **Padrões Aplicados:**
>
