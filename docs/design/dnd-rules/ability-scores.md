...
> - **Base (Point Buy):** 8-15
> - **After Racial Bonuses:** 8-17 (typically)
> - **Maximum (with ASI):** 20
...
> ```
> FinalScore = BaseScore + RacialBonuses + ASI
> ```
>
> **Onde:**
> - `BaseScore`: Score do Point Buy (8-15)
> - `RacialBonuses`: Bônus da raça/sub-raça
> - `ASI`: Ability Score Improvements (de level up)
