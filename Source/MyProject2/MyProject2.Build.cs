...
public class MyProject2 : ModuleRules
{
    public MyProject2(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(
            new string[] { "Core", "CoreUObject", "Engine", "InputCore", "EnhancedInput", "GameplayTags" });
        ...
        // Permite usar: #include "Utils/CharacterSheetHelpers.h" ao invés de #include
        // "../../Utils/CharacterSheetHelpers.h"
